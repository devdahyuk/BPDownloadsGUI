...
if (UI.dark_mode) {
  ...
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended@master/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended@master/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended@master/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended@master/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended@master/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended@master/js/DPlayer.min.js"></script>'
);
document.write(
